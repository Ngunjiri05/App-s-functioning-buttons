...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnMap = findViewById(R.id.mMap)
        // set onclocklisteners to the buttons
        btnSms.setOnClickListener {
            val uri = Uri.parse("smsto:0705852018");
        ...
        btnEmail.setOnClickListener {
            val emailIntent =
                Intent(
                    ...
                    Uri.fromParts("mailto", "slyshiku129@gmail.com@gmail.com", null)
                )
            emailIntent.putExtra(Intent.EXTRA_SUBJECT, "JOB APPLICATION")
            emailIntent.putExtra(Intent.EXTRA_TEXT, "Dear Madam, following the job adv.....;")
        ...
        btnShare.setOnClickListener {
            ...
            shareIntent.putExtra(Intent.EXTRA_TEXT, "Hey, download this app onn https://www!")
            startActivity(shareIntent)

        }
        btnMpesa.setOnClickListener {
            val simToolKitLaunchIntent = getApplicationContext().getPackageManager()
                .getLaunchIntentForPackage("com.android.stk");
            if (simToolKitLaunchIntent != null) {
                startActivity(simToolKitLaunchIntent);
            }
            btnCall.setOnClickListener {
                val intent = Intent(Intent.ACTION_CALL, Uri.parse("tel:" + "0705852018"))
